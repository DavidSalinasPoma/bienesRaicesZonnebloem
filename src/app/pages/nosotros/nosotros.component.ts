...
export class NosotrosComponent implements OnInit {
  ...
  public mapaBienesRaices() {
    ...
    if ($('#mapa').length) {
      ...
      const map = L.map('mapa').setView([-17.388280, -66.159193], 18);
      ...
      L.marker([-17.388280, -66.159193]).addTo(map)
        ...
        .bindPopup('<center> <img src="../../../assets/img/logo.png" alt="" style="width: 150px;"><br>Bienes Raices.<br> Calle Mexico Nro. 0169 entre Baptista y Ayacucho.</center>')
        .openPopup();
